...
const {getUserFavoritePaintings, getRecommendedPaintings, getAllPaintings, getPainting, savePainting, deletePainting } = require('../controllers/paintingController')
...
routes.get('/gallery/recommended', auth, getRecommendedPaintings);
routes.get('/gallery/favorites', auth, getUserFavoritePaintings);
